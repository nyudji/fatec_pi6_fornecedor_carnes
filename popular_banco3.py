...
conn.autocommit = False # Desabilitar autocommit para gerenciar transações manualmente
cursor = conn.cursor()
fake = Faker("pt_BR")
...
# --- INSERIR FORNECEDOR FIXO (mantido como está) ---
...
for i in range(0, len(pagamentos_data_list), BATCH_SIZE_PAGAMENTOS):
    ...
    # ATENÇÃO: Se você mudou o nome da coluna no seu DB para 'referencia_pagamento', mude aqui também!
    execute_values(cursor, """
